...
{
    internal class ContextableComparerAdapater : IContextableComparer
    {
        readonly IComparer _comparer;

        public ContextableComparerAdapater(IComparer comparer)
        {
        ...
        public IEnumerable<Difference> CalculateDifferences(Type type, object obj1, object obj2, IComparisonContext comparisonContext)
        {
            ...
            if (_comparer is IContextableComparer contextableComparer)
            {
                return contextableComparer.CalculateDifferences(type, obj1, obj2, comparisonContext);
            }

            ThrowContextableComparerNotImplemented(comparisonContext, _comparer.Settings, _comparer, nameof(IContextableComparer));

            return _comparer.CalculateDifferences(obj1, obj2);
        }
    ...
    {
        /// <summary>
        /// For implementors of <see cref="IContextableComparer"/>.
        /// </summary>
        public static IContextableComparer AsContextable(this IComparer comparer)
        {
            return new ContextableComparerAdapater(comparer);
        }

...
{
    /// <summary>
    /// Depending on the configuration, the exception is thrown if the key provider does not supply the key for list element <see cref="KeylessElement"/>. For more information see <see cref="CompareListElementsByKeyOptions.UseKey(Func{object, object})"/> and <see cref="CompareListElementsByKeyOptions.ThrowKeyNotFound"/>.
    /// </summary>
    public class ElementKeyNotFoundException : Exception
    {
        ...
        internal ElementKeyNotFoundException(object keylessElement, ComparisonContext keylessElementComparisonContext, string message = ElementKeyNotFoundExceptionMsg) : base(message)
        {
        ...
        /// </summary>
        public ComparisonContext KeylessElementComparisonContext { get; }
    }
}
